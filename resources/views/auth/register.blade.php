        ...
        <div class="w-96 p-6 rounded-lg bg-blue-900 shadow-xl">
            ...
            <form method="POST" action="{{ route('register') }}" class="pt-8">
                ...
                <div class="relative">
                    ...
                    <input id="name" type="text" class="w-full pt-8 pl-3 rounded focus:outline-none focus:bg-blue-700 bg-blue-800 text-gray-100 @error('name') border border-red-600 @enderror" name="name" value="{{ old('name') }}" required autocomplete="name" autofocus placeholder="Your Name">
                ...
                <div class="relative pt-3">
                    ...
                    <input id="email" type="email" class="w-full pl-3 pt-8 rounded focus:outline-none focus:bg-blue-700 bg-blue-800 text-gray-100 @error('email') border border-red-600 @enderror" name="email" value="{{ old('email') }}" required autocomplete="email" autofocus placeholder="your@email.com">
                ...
                <div class="relative pt-3">
                    ...
                    <input id="password" type="password" class="w-full pl-3 pt-8 rounded focus:outline-none focus:bg-blue-700 bg-blue-800 text-gray-100 @error('password') border border-red-600 @enderror" name="password" required autocomplete="current-password" placeholder="Password">
                ...
                <div class="relative pt-3">
                    ...
                    <input id="password-confirm" type="password" class="w-full pl-3 pt-8 rounded focus:outline-none focus:bg-blue-700 bg-blue-800 text-gray-100" name="password_confirmation" required placeholder="Confirm">
                </div>
