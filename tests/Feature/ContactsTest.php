...
class ContactsTest extends TestCase
{
    ...
    public function an_authenticated_user_can_add_a_contact()   ///////
    {
        ...
        $this->assertEquals('Maths', $contact->subject);
        $this->assertEquals('Kildare', $contact->location);
        $this->assertEquals('Hi, I am Cormac', $contact->description);
